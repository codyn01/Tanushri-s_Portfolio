  ...
  return (
    <section className="about-section">
      ...
      <section className="info-section">
        <TypewriterHeading
          text="Hello There, Welcome To My Universe"
        ...
        <div className="info-cards">
          ...
          <div className="card">
            ...
            <p>
              Passionate Computer Science & Engineer. Building impactful
              projects with AI, ML, and
              <br /> Full-Stack Development. Turning ideas <br />
          ...
          <div className="card">
            <h1>Code is Craft</h1>
            <p>
              Clean code is my art. Simple, scalable, and timeless. Every line
              should solve a problem beautifully.
            </p>
          ...
          <div className="card">
            ...
            <button
              onClick={() =>
                window.open("https://wa.me/919362118496", "_blank")
              }
            >
          ...
          <div className="card">
            ...
            <p>
              ...
              <br /> <b>Languages:</b> C, C++, Python, Java
              <br />
              <b>Web:</b> HTML, CSS, JavaScript
              <br />
              <b>Tools:</b> GitHub, Figma, Streamlit, MySQL Domains: ML, Data
              Science, Full-Stack
              <br />
              etc.
            </p>
